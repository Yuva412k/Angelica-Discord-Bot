...
class Track {
    ...
    constructor (videoData, user, player) {
         ...
         * @type {string}
         */
        this.duration = videoData.duration.timestamp ? videoData.duration.timestamp : `${Math.floor(parseInt(videoData.lengthSeconds) / 60)}:${parseInt(videoData.lengthSeconds) % 60}`;
